...
class TodoListTest < Minitest::Test
  ...
  def test_all_done
    ...
    done_todo = TodoList.new("Done")
    done_todo.add(@todo1)
    done_todo.add(@todo3)

    assert_equal(done_todo, @list.all_done)
  end

  def test_equality_empty
    todolist1 = TodoList.new('Hello')
    todolist2 = TodoList.new('Goodbye')

    assert_equal(todolist1, todolist2)
  end

  def test_equality_todos_list
    todolist1 = TodoList.new('Hello')
    todolist2 = TodoList.new('Goodbye')
  ...
  def test_all_not_done
    ...
    done_todo = TodoList.new("Not Done")
    done_todo.add(@todo2)

    assert_equal(done_todo, @list.all_not_done)
  end
  ...
  def test_mark_done_at
    ...
    @list.mark_done('Buy Milk', 'go to gym')
